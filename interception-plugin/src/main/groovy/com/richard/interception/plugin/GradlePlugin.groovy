...
import com.richard.interception.plugin.bean.PluginConfig
...
class GradlePlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        if (isAndroidApplication || isAndroidLibrary) {
            project.dependencies.add("implementation", "com.github.richardpaco.interception:interception-core:${Version.VERSION}")
            boolean isKotlinProject = project.plugins.findPlugin("kotlin-android") != null
            if (isKotlinProject) {
                project.dependencies.add("kapt", "com.github.richardpaco.interception:interception-processor:${Version.VERSION}")
            } else {
                project.dependencies.add("annotationProcessor", "com.github.richardpaco.interception:interception-processor:${Version.VERSION}")
            }
